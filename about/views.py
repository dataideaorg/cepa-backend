...
from .models import (
    ...
    OurStorySection, WhatSetsUsApartSection, CallToActionSection, TeamMember, Partner
)
from .serializers import (
    ...
    CallToActionSectionSerializer, TeamMemberSerializer, PartnerSerializer, AboutPageSerializer
)
